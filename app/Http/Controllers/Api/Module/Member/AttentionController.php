...
class AttentionController extends BaseController
{
  ...
  /**
   * @api {get} /api/member/attention/list?page={page} 01. 当前会员关注列表
   ...
   * @apiSuccess (member params) {Number} nickname 当前会员昵称
   * @apiSuccess (attention params) {Number} nickname 关注会员昵称
   *
  ...
  /**
   * @api {get} /api/member/attention/select 02. 当前会员关注数据
   ...
   * @apiDescription 当前会员执行关注操作, 已经关注过执行取消关注
   * @apiGroup 23. 会员关注模块
   * @apiPermission jwt
   * @apiHeader {String} Authorization 身份令牌
   * @apiHeaderExample {json} Header-Example:
   ...
   * }
   *
   * @apiParam {string} attention_member_id 关注会员编号
   *
