...
{
  protected $_model = 'App\Models\Api\Module\Member\Address';
  ...
  /**
   * @api {get} /api/member/address/list?page={page} 01. 当前会员地址列表
   * @apiDescription 获取当前会员地址分页列表
   * @apiGroup 22. 会员地址模块
   * @apiPermission jwt
  ...
  /**
   * @api {get} /api/member/address/select 02. 当前会员地址数据
   * @apiDescription 获取当前会员地址不分页列表数据
   * @apiGroup 22. 会员地址模块
   * @apiPermission jwt
   * @apiHeader {String} Authorization 身份令牌
   * @apiHeaderExample {json} Header-Example:
  ...
  /**
   * @api {get} /api/member/address/view/{id} 03. 当前会员地址详情
   * @apiDescription 获取当前会员地址详情
   * @apiGroup 22. 会员地址模块
   * @apiPermission jwt
   * @apiHeader {String} Authorization 身份令牌
   * @apiHeaderExample {json} Header-Example:
  ...
  /**
   * @api {get} /api/member/address/default 04. 获取当前会员默认地址
   * @apiDescription 获取当前会员默认地址详情
   * @apiGroup 22. 会员地址模块
   * @apiPermission jwt
   * @apiHeader {String} Authorization 身份令牌
   * @apiHeaderExample {json} Header-Example:
  ...
  /**
   * @api {post} /api/member/address/handle 05. 编辑会员地址
   * @apiDescription 编辑当前会员地址信息
   * @apiGroup 22. 会员地址模块
   * @apiPermission jwt
   * @apiHeader {String} Authorization 身份令牌
   * @apiHeaderExample {json} Header-Example:
  ...
  /**
   * @api {post} /api/member/address/delete 06. 当前会员地址删除
   * @apiDescription 删除当前会员的地址信息
   * @apiGroup 22. 会员地址模块
   * @apiPermission jwt
   * @apiHeader {String} Authorization 身份令牌
   * @apiHeaderExample {json} Header-Example:
